...
int AndroidBleProtocol::StartScan()
{
	...
	dataRequest["netKey"] = gateway->getBleNetKey();
	dataRequest["appKey"] = gateway->getBleAppKey();
	...
	element.append(BLE_WIFI_RGB_SOCKET_1);
	...
	secondElements.append(BLE_WIFI_RGB_SOCKET_2);
