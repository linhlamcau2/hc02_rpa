...
int Db::DeviceInGroupDel(string groupId, string deviceId, int epId)
{
	string sql = "DELETE FROM " TABLE_NAME " WHERE group_id= '" + groupId + "' AND device_id='" + deviceId + "' AND element = " + to_string(epId) + ";";
	return Sqlite_Exec(sql);
}
