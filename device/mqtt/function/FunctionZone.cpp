...
{
	if (dataValue.isMember("zoneId") && dataValue["zoneId"].isString() &&
			dataValue.isMember("zoneValue") && dataValue["zoneValue"].isInt())
	{
		string zoneId = dataValue["zoneId"].asString();
		int zoneValue = dataValue["zoneValue"].asInt();
