...
DeviceBleSeftPowerRemote::DeviceBleSeftPowerRemote(string id, string name, string mac, Json::Value &dataJson, uint32_t addr, uint32_t type, uint16_t version, Device *parent)
