...
class DeviceBleDownLightCobGocHep : public DeviceBle
{
private:
...
public:
	DeviceBleDownLightCobGocHep(string id, string name, string mac, string device_id, uint32_t addr, uint16_t version);
