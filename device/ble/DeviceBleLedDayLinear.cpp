...
DeviceBleLedDayLinear::DeviceBleLedDayLinear(string id, string name, string mac, string device_id, uint32_t addr, uint16_t version)
		: DeviceBle(id, name, mac, device_id, addr, BLE_LED_DAY_LINEAR, version)
{
...
void DeviceBleLedDayLinear::InputData(uint8_t *data, int len, uint32_t addr)
{
	typedef struct
	{
		uint16_t u16Opcode;
...
bool DeviceBleLedDayLinear::CheckData(Json::Value &dataValue, bool &rs)
{
...
bool DeviceBleLedDayLinear::Do(int id, int value)
{
...
bool DeviceBleLedDayLinear::Do(Json::Value &dataValue)
{
