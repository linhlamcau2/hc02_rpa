...
DeviceBlePanelVuong::DeviceBlePanelVuong(string id, string name, string mac, string device_id, uint32_t addr, uint16_t version)
		: DeviceBle(id, name, mac, device_id, addr, BLE_PANEL_VUONG, version)
{
...
void DeviceBlePanelVuong::InputData(uint8_t *data, int len, uint32_t addr)
{
	typedef struct
	{
		uint16_t u16Opcode;
...
bool DeviceBlePanelVuong::CheckData(Json::Value &dataValue, bool &rs)
{
...
bool DeviceBlePanelVuong::Do(int id, int value)
{
...
bool DeviceBlePanelVuong::Do(Json::Value &dataValue)
{
