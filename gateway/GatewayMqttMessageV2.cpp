...
void Gateway::initMqttMessageV2()
{
	...
	OnLocalCallbackRegisterV2("addFavoriteDev", bind(&Gateway::OnAddFavoriteDev, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("delFavoriteDev", bind(&Gateway::OnDelFavoriteDev, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("addFavoriteScene", bind(&Gateway::OnAddFavoriteScene, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("delFavoriteScene", bind(&Gateway::OnDelFavoriteScene, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("getDevListInGroup", bind(&Gateway::OnGetDevListInGroup, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("getDevFavorite", bind(&Gateway::OnGetDevFavorite, this, placeholders::_1, placeholders::_2));
	OnLocalCallbackRegisterV2("getSceneFavorite", bind(&Gateway::OnGetSceneFavorite, this, placeholders::_1, placeholders::_2));
#endif
}
